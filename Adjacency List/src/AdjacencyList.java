public class AdjacencyList {
    ...
    public void addEdge(Vertex source, Vertex dest) {
        ...
        adjacencyList[sourceIndex].friendsList.add(adjacencyList[destIndex]);
    }
    ...
    public void deleteEdge(Vertex source, Vertex dest) {
        ...
        adjacencyList[sourceIndex].friendsList.remove(adjacencyList[destIndex]);
    }
    ...
    public void print() {
        for (int i = 0; i < adjacencyList.length; i++) {
            ...
            for (Vertex edge : adjacencyList[i].friendsList) {
